-- =============================================
-- SARKAR CRM DATABASE SETUP (HANDLES EXISTING TYPES)
-- =============================================

-- STEP 1: CREATE ENUMS AND TYPES (IF NOT EXISTS)
DO $$ BEGIN
...
-- STEP 2: DROP EXISTING TABLES IF THEY EXIST (IN CORRECT ORDER)
...
DROP POLICY IF EXISTS "Users can view their store's customer documents" ON storage.objects;
