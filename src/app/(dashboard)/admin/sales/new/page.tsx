...
export default function NewSale() {
  ...
  const [salespeople] = useState<Salesperson[]>([
    { id: '1', name: 'Salesperson 1' },
    { id: '2', name: 'Salesperson 2' },
    { id: '3', name: 'Salesperson 3' }
  ]);
    ...
    <DashboardLayout>
      <div className="p-6">
        <PageHeader
          ...
          description="Add a new sales transaction to the system"
          breadcrumbs={true}
          showBackButton={true}
          onBack={handleBack}
          actions={
        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Fill in the details below to record a new sale transaction
              </CardDescription>
            </CardHeader>
            <CardContent>
              {error && (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Salesperson and Floor */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="salespersonId">Salesperson</Label>
                    <Select value={formData.salespersonId} onValueChange={(value) => handleInputChange('salespersonId', value)}>
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.floorId} onValueChange={(value) => handleInputChange('floorId', value)}>
                      <SelectTrigger>
